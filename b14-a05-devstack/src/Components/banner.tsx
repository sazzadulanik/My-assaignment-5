  ...
  return (
    <section className="bg-white">
      ...
      <div className="px-4 lg:px-8 text-center lg:text-left">
           ...
           <p className="mt-8 mb-6 text-lg leading-8 text-gray-600 text-center lg:text-left">
          ...
          <div>
            <img
              src="/assets/banner-stack.png" alt="" className="w-full max-w-full mt-8 lg:mt-0" />
          </div>
