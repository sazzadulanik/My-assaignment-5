      ...
      <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
        {technologies.map((technology) => (
          <div key={technology.name}
            className="relative flex h-full flex-col rounded-2xl border border-gray-200 bg-white p-5 shadow-sm transition-all duration-300 hover:shadow-lg" >
            ...
            <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-gray-50">
              <StackIcon name={technology.icon} variant="light" />
            </div>
            ...
            >
              {stack.some((item) => item.name === technology.name) ? " Added to Stack": "Add to Stack"}
